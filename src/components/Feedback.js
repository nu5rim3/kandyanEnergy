                    ...
                    <div className="Section__feedback__bottom">
                        ...
                        <div className="grid grid-cols-4">
                            <div className="Section__feedback__bottom__card pr-12">
                                <img src="https://via.placeholder.com/250x200" alt="kandyan energy" className="Section__feedback__bottom__card__image rounded-xl" />
                                <div className="flex flex-wrap justify-between pt-3">
                                    ...
                                    <div className="Section__feedback__bottom__card__volt text-sm text-green-400 font-extrabold">⚡ 24kW</div>
                                </div>
                            ...
                            <div className="Section__feedback__bottom__card pr-12">
                                ...
                                <div className="flex flex-wrap justify-between pt-3">
                                    <div className="Section__feedback__bottom__card__type text-xs text-white font-semibold">solarX panel</div>
                                    <div className="Section__feedback__bottom__card__volt text-sm text-green-400 font-extrabold">⚡ 332kW</div>
                                </div>
                            ...
                            <div className="Section__feedback__bottom__card pr-12">
                                ...
                                <div className="flex flex-wrap justify-between pt-3">
                                    <div className="Section__feedback__bottom__card__type text-xs text-white font-semibold">solarX panel</div>
                                    <div className="Section__feedback__bottom__card__volt text-sm text-green-400 font-extrabold">⚡ 120kW</div>
                                </div>
                            ...
                            <div className="Section__feedback__bottom__card pr-12">
                                ...
                                <div className="flex flex-wrap justify-between pt-3">
                                    <div className="Section__feedback__bottom__card__type text-xs text-white font-semibold">solarX panel</div>
                                    <div className="Section__feedback__bottom__card__volt text-sm text-green-400 font-extrabold">⚡ 32kW</div>
                                </div>
