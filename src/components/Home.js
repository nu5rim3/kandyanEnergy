            ...
            <div className="Section__home__header grid grid-cols-12 gap-4">
                <div className="col-start-2 col-span-10 flex">
                    ...
                    <div className="h-full w-1/2 flex flex-wrap content-center justify-end pt-32">
                        <div className="Section__contact__card__form grid grid-cols-8 gap-4 bg-green-400 py-10 px-14 rounded-xl shadow-xl">
                            ...
                            <div className="col-span-8">
                                <button className="w-full rounded-md bg-gray-900 flex items-center py-2 justify-center hover:shadow-xl hover:bg-gray-600">
                                    <div className="font-bold text-white">Calculate</div>
                                </button>
                            </div>
                        </div>
