            ...
            <div className="Section__about__top pt-32">
                <div className="grid grid-cols-12">
                    <div className="col-start-2 col-span-10">
                        <div className="Section__feedback__top__topic text-green-400 font-semibold text-xl">About Us</div>
                        <div className="flex flex-wrap">
                            <div className="w-full md:w-2/3">
                                <div className="text-white font-extrabold text-2xl md:text-3xl pt-10">We manage our conduct by what is right for people, the environment, and the profession we love.</div>
                            </div>
                        </div>
                        <div className="hidden md:flex flex-wrap pt-5">
                    ...
                    <div className="col-start-2 col-span-10">
                        <div className="flex flex-wrap md:pt-20">
                            <div className="w-1/2 md:w-1/4 flex flex-col">
                                ...
                                <div className="text-white font-semibold text-xl md:text-4xl flex justify-center pt-5">1000+</div>
                            ...
                            <div className="w-1/2 md:w-1/4 flex flex-col">
                                ...
                                <div className="text-white font-semibold text-xl md:text-4xl flex justify-center pt-5">100+</div>
                            ...
                            <div className="w-1/2 md:w-1/4 flex flex-col">
                                ...
                                <div className="text-white font-semibold text-xl md:text-4xl flex justify-center pt-5">90,000 kW</div>
                            ...
                            <div className="w-1/2 md:w-1/4 flex flex-col">
                                ...
                                <div className="text-white font-semibold text-xl md:text-4xl flex justify-center pt-5">20 + years</div>
